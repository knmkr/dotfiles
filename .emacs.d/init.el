...
(custom-set-faces
 ...
 '(magit-diff-file-heading ((t (:foreground "cyan" :weight bold))))
 '(magit-diff-file-heading-highlight ((t (:foreground "cyan"))))
 '(magit-diff-hunk-heading ((t (:foreground "cyan" :underline t))))
 '(magit-diff-hunk-heading-highlight ((t (:background "grey30" :underline t))))
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(tide typescript-mode magit flycheck terraform-mode blacken py-isort php-mode go-autocomplete jedi editorconfig go-mode ess session ruby-electric scala-mode auto-install yaml-mode rainbow-mode auto-complete hl-line+))
